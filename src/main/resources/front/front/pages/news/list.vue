		...
		<view :style='{"width":"100%","padding":"0","position":"relative","background":"#fff","height":"100%"}'>
			<view class="cu-bar bg-white search" :style='{"width":"100%","padding":"20rpx 24rpx","background":"#fff","display":"flex","height":"auto"}'>
				...
				<view :style='{"margin":"0 12rpx","flex":"1","position":"relative"}' v-if="queryIndex==0" class="search-form round">
					...
					<input :style='{"border":"2rpx solid #A1A1A1","padding":"12rpx 20rpx 12rpx 80rpx","color":"#000","borderRadius":"10rpx","background":"#fff","width":"100%","lineHeight":"56rpx","fontSize":"28rpx","height":"80rpx"}' v-model="searchForm.title" type="text" placeholder="标题" ></input>
				</view>
			...
			<view :style='{"width":"100%","background":"#fff","height":"auto"}'>
				...
				<view class="news-box1" :style='{"width":"100%","padding":"24rpx","margin":"0","height":"auto"}'>
					<view @tap="onDetailTap(product)" v-for="(product,index) in list" :key="index" class="list-item" :style='{"boxShadow":"0 2rpx 12rpx rgba(0,0,0,.3)","padding":"20rpx 20rpx 20rpx 0","margin":"0 0 20rpx","borderRadius":"10rpx","flexWrap":"wrap","display":"flex","width":"100%","height":"auto"}'>
					  <view class="list-item-body" :style='{"width":"calc(100% - 200rpx)","padding":"8rpx 20rpx","margin":"0","flexWrap":"wrap","display":"flex","height":"auto"}'>
						<view :style='{"padding":"0 ","margin":"0","whiteSpace":"nowrap","overflow":"hidden","color":"#000","width":"100%","lineHeight":"1.8","fontSize":"28rpx","textOverflow":"ellipsis","order":"1"}' class="title ">{{product.title}}</view>
						<view :style='{"padding":"0 0","margin":"0","whiteSpace":"nowrap","overflow":"hidden","color":"#9E9E9E","width":"100%","lineHeight":"2","fontSize":"28rpx","textOverflow":"ellipsis","order":"2"}' class="text ">{{product.introduction}}</view>
						<view :style='{"width":"50%","padding":"0 0","order":"7"}'>
							<text class="icon iconfont icon-shijian21" :style='{"margin":"0 4rpx 0 0","lineHeight":"1.5","fontSize":"20rpx","color":"#9E9E9E"}'></text>
							<text :style='{"color":"#9E9E9E","lineHeight":"1.5","fontSize":"20rpx"}'>{{product.addtime}}</text>
						</view>
						<view :style='{"width":"50%","padding":"0 0","display":"inline-block","order":"6"}'>
							<text class="icon iconfont icon-geren16" :style='{"margin":"0 4rpx 0 0","lineHeight":"1.5","fontSize":"24rpx","color":"#9E9E9E"}'></text>
							<text :style='{"color":"#9E9E9E","lineHeight":"1.5","fontSize":"24rpx"}'>{{product.name}}</text>
						</view>
						<view :style='{"width":"calc(100% / 3)","padding":"0 0 0","display":"inline-block","order":"3"}'>
							<text class="icon iconfont icon-zan10" :style='{"margin":"0 4rpx 0 0","lineHeight":"1.5","fontSize":"24rpx","color":"#9E9E9E"}'></text>
							<text :style='{"color":"#9E9E9E","lineHeight":"1.5","fontSize":"24rpx"}'>{{product.thumbsupnum}}</text>
						</view>
						<view :style='{"width":"calc(100% / 3)","padding":"0 0 ","display":"inline-block","order":"4"}'>
						...
						<view :style='{"width":"calc(100% / 3)","padding":"0 0 ","display":"inline-block","order":"5"}'>
					  ...
					  <image :style='{"width":"200rpx","objectFit":"cover","borderRadius":"10rpx","display":"block","height":"200rpx"}' mode="aspectFill" class="listmpic" :src="baseUrl+product.picture"></image>
					</view>
				</view>
